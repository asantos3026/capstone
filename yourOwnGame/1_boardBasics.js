...
//     // Now try adding gamePieces to a couple of different rows throughout the board using this makePiece funcion. 
    makePiece(gameBoard, [2, 4], 'bomberman');
    gameBoard[2][4].gamePiece.imageURL = "http://vectorlib.free.fr/BomberMan/jpg/bomberman.jpg"

    for(var i = 0; i < gameBoard.length; i++){
      for (var j = 0; j < gameBoard[0].length; j++){
        if (i % 2 === 0 && j % 2 === 0) {
          makePiece(gameBoard, [i, j], 'bomberman');
          gameBoard[i][j].gamePiece.imageURL = "http://vectorlib.free.fr/BomberMan/jpg/bomberman.jpg";
        }    
      }
    } 
...
//       gameBoard[row][square].gamePiece.imageURL = "http://vectorlib.free.fr/BomberMan/jpg/bomberman.jpg"; 
//   });
// });
    ...
    var resultsWithEach = _.map(gameBoard, function(row, square) {
